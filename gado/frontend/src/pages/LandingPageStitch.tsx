  ...
  const testimonials = [
    {
      ...
      content: 'GadoWallet gave me complete peace of mind. The security features are incredible and the interface is so intuitive.',
      rating: 5,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20 animate-on-scroll">
            <div className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-md border border-white/20 rounded-full px-6 py-3 mb-8">
              <Sparkles className="w-5 h-5 text-yellow-400" />
              <span className="text-white font-medium">Why Choose GadoWallet</span>
            </div>
      ...
      <section className="py-32 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20 animate-on-scroll">
            ...
            <p className="text-xl text-white/80 max-w-3xl mx-auto">
              Join thousands of satisfied users who trust GadoWallet with their digital legacy
            </p>
          </div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="glass-card p-16 animate-on-scroll">
            ...
            <p className="text-xl text-white/80 mb-12 max-w-3xl mx-auto">
              Join thousands of users who trust GadoWallet to protect their crypto assets and ensure a smooth transfer to their loved ones.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center space-x-3 mb-6">
                ...
                <span className="text-2xl font-bold text-white">GadoWallet</span>
              </div>
          ...
          <div className="border-t border-white/10 mt-12 pt-8 text-center">
            <p className="text-white/60">
              © 2024 GadoWallet. All rights reserved. Built with ❤️ on Solana.
            </p>
          </div>
        </div>
      </footer>
