          ...
          <div className="text-center mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
              <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 hover:bg-white/15 transition-all duration-300 transform hover:scale-105">
                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500 to-cyan-500 text-white flex items-center justify-center mb-4 mx-auto">
                  <Wallet className="w-6 h-6" />
                </div>
                <h3 className="font-bold text-white mb-2">Smart Wallet</h3>
                <p className="text-sm text-gray-300">Unique address for receiving funds directly</p>
              </div>
              
              <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 hover:bg-white/15 transition-all duration-300 transform hover:scale-105">
                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-purple-500 to-pink-500 text-white flex items-center justify-center mb-4 mx-auto">
                  <Bell className="w-6 h-6" />
                </div>
                <h3 className="font-bold text-white mb-2">Live Notifications</h3>
                <p className="text-sm text-gray-300">Real-time alerts for every transaction</p>
              </div>
              
              <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 hover:bg-white/15 transition-all duration-300 transform hover:scale-105">
                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-emerald-500 to-teal-500 text-white flex items-center justify-center mb-4 mx-auto">
                  <Users className="w-6 h-6" />
                </div>
                <h3 className="font-bold text-white mb-2">Multi-Heir Support</h3>
                <p className="text-sm text-gray-300">Up to 10 heirs with premium features</p>
              </div>
              
              <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 hover:bg-white/15 transition-all duration-300 transform hover:scale-105">
                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-yellow-500 to-orange-500 text-white flex items-center justify-center mb-4 mx-auto">
                  <Crown className="w-6 h-6" />
                </div>
                <h3 className="font-bold text-white mb-2">Premium Upgrades</h3>
                <p className="text-sm text-gray-300">Modify inheritance settings anytime</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mt-12">
            <p className="text-gray-400">
              ✨ You can upgrade from Free to Premium anytime and modify your existing Smart Wallet settings
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="stats" className="relative container mx-auto px-4 py-20">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="text-4xl md:text-6xl font-bold bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent mb-2">1000+</div>
              <div className="text-gray-300">Smart Wallets Created</div>
            </div>
            <div className="text-center">
              <div className="text-4xl md:text-6xl font-bold bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent mb-2">5000+</div>
              <div className="text-gray-300">Heirs Designated</div>
            </div>
            <div className="text-center">
              <div className="text-4xl md:text-6xl font-bold bg-gradient-to-r from-emerald-400 to-teal-400 bg-clip-text text-transparent mb-2">$50M+</div>
              <div className="text-gray-300">Assets Protected</div>
            </div>
            <div className="text-center">
              <div className="text-4xl md:text-6xl font-bold bg-gradient-to-r from-yellow-400 to-orange-400 bg-clip-text text-transparent mb-2">99.9%</div>
